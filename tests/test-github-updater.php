...
mgd_ail_updater_assert_contains( 'Version:            0.6.4', $plugin_source, 'Die Plugin-Metadaten enthalten die veröffentlichte Release-Version 0.6.4.' );
...
mgd_ail_updater_assert_contains( "define( 'MGD_AI_IMAGE_LABELS_VERSION', '0.6.4' );", $plugin_source, 'Die Laufzeit-Konstante entspricht der Plugin-Version.' );
